...
export const STRINGS = {
  ...
  en: {
    ...
    hero: {
      ...
      typed: ["THE BASEBALL BAT", "CHAMPION OF 6 NATIONS", "#1 NORTH AMERICA · AJP", "50+ CHOKE FINISHES"],
      sub: "Brazilian jiu-jitsu. National champion of six countries, nine AJP gold medals. Over 50 opponents finished with one and the same move — the baseball choke. Hence the nickname.",
    ...
    dossier: {
      ...
      cards: [
        ...
        { title: "9 AJP golds", text: "Russia, Qatar, Switzerland, Spain, Germany, Latvia — national titles in six countries, plus Grand Slam Moscow gold." },
    ...
    stats: [
      { label: "AJP & ACBJJ medals", trend: "9 of them — gold" },
    ...
    voices: {
      ...
      items: [
        ...
        { name: "Dmitry Safonov", role: "Commentator", org: "AJP Tour Russia", date: "February 2026", text: "When Nagoryansky gets the collar, the stands rise. Everyone knows what comes next — and nobody has stopped it yet." },
      ],
    },
    pricing: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Is the baseball choke safe for beginners?", a: "Yes, when taught properly. At seminars we start with defense and only then move to attack. Chokes in BJJ are controlled: you tap — your partner releases. The most dangerous thing on the mat is ego, not techniques." },
      ],
    },
    cta: {
    ...
    footer: {
      about: "Brazilian jiu-jitsu. #1 of the AJP North America ranking, #2 in the world. National champion of six countries. Lausanne / Saint Petersburg.",
      sections: "Sections", training: "Training", contact: "Contact",
      collab: "Collaboration — DM", subscribe: "Subscribe",
      copyright: "© 2026 Vladimir Nagoryansky — The Baseball Bat. All submissions are voluntary.",
  ...
  ru: {
    ...
    hero: {
      ...
      typed: ["THE BASEBALL BAT", "ЧЕМПИОН 6 СТРАН", "#1 СЕВЕРНАЯ АМЕРИКА · AJP", "50+ ФИНИШЕЙ ЧОКОМ"],
      sub: "Бразильское джиу-джитсу. Национальный чемпион шести стран, девять золотых медалей AJP. Больше 50 соперников финишированы одним и тем же приёмом — baseball choke. Отсюда и прозвище.",
    ...
    dossier: {
      ...
      cards: [
        ...
        { title: "9 золотых AJP", text: "Россия, Катар, Швейцария, Испания, Германия, Латвия — национальные титулы шести стран плюс золото Grand Slam Moscow." },
    ...
    stats: [
      { label: "медалей AJP & ACBJJ", trend: "9 из них — золото" },
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Baseball choke — это безопасно для новичков?", a: "Да, при грамотной подаче. На семинарах мы начинаем с защиты и только потом переходим к атаке. Удушающие в BJJ контролируемы: похлопал — партнёр отпустил. Опаснее всего на татами эго, а не приёмы." },
      ],
    },
    cta: {
    ...
    footer: {
      about: "Бразильское джиу-джитсу. №1 рейтинга AJP Северной Америки, №2 в мире. Национальный чемпион шести стран. Лозанна / Санкт-Петербург.",
  ...
  es: {
    ...
    hero: {
      ...
      name1: "Vladimir", name2: "Nagoryansky",
      typed: ["THE BASEBALL BAT", "CAMPEÓN DE 6 PAÍSES", "#1 NORTEAMÉRICA · AJP", "50+ FINALIZACIONES"],
      sub: "Jiu-jitsu brasileño. Campeón nacional de seis países, nueve oros AJP. Más de 50 rivales finalizados con el mismo movimiento: el baseball choke. De ahí el apodo.",
    ...
    dossier: {
      ...
      cards: [
        ...
        { title: "9 oros AJP", text: "Rusia, Catar, Suiza, España, Alemania, Letonia — títulos nacionales en seis países, más el oro del Grand Slam de Moscú." },
    ...
    stats: [
      { label: "medallas AJP & ACBJJ", trend: "9 de ellas — oro" },
    ...
    voices: {
      ...
      items: [
        ...
        { name: "Dmitry Safonov", role: "Comentarista", org: "AJP Tour Russia", date: "Febrero 2026", text: "Cuando Nagoryansky agarra el cuello del gi, las gradas se levantan. Todos saben lo que viene — y nadie ha podido pararlo." },
      ],
    },
    pricing: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "¿El baseball choke es seguro para principiantes?", a: "Sí, bien enseñado. En los seminarios empezamos por la defensa y solo después pasamos al ataque. Las estrangulaciones en BJJ están controladas: tocas — tu compañero suelta. Lo más peligroso del tatami es el ego, no las técnicas." },
      ],
    },
    ...
    footer: {
      about: "Jiu-jitsu brasileño. №1 del ranking AJP de Norteamérica, №2 del mundo. Campeón nacional de seis países. Lausana / San Petersburgo.",
      sections: "Secciones", training: "Entrenos", contact: "Contacto",
      collab: "Colaboraciones — por DM", subscribe: "Suscripción",
      copyright: "© 2026 Vladimir Nagoryansky — The Baseball Bat. Todas las luxaciones son voluntarias.",
  ...
  zh: {
    ...
    hero: {
      ...
      typed: ["THE BASEBALL BAT", "六国全国冠军", "北美第一 · AJP", "50+次绞技终结"],
      sub: "巴西柔术运动员。六个国家的全国冠军，九枚AJP金牌。超过50名对手被同一招终结——棒球绞（baseball choke）。绰号由此而来。",
    ...
    dossier: {
      ...
      cards: [
        ...
        { title: "9枚AJP金牌", text: "俄罗斯、卡塔尔、瑞士、西班牙、德国、拉脱维亚——六国全国冠军，外加莫斯科大满贯金牌。" },
    ...
    stats: [
      { label: "AJP & ACBJJ 奖牌", trend: "其中9枚金牌" },
    ...
    faq: {
      ...
      items: [
        ...
        { q: "棒球绞对新手安全吗？", a: "教学得当就安全。研讨课上我们先学防守，再学进攻。柔术中的绞技是可控的：拍垫即松。垫子上最危险的是自负，不是技术。" },
      ],
    },
    ...
    footer: {
      about: "巴西柔术。AJP北美排名第一、世界第二。六个国家的全国冠军。洛桑 / 圣彼得堡。",
  ...
  tr: {
    ...
    hero: {
      ...
      name1: "Vladimir", name2: "Nagoryansky",
      typed: ["THE BASEBALL BAT", "6 ÜLKENİN ŞAMPİYONU", "KUZEY AMERİKA #1 · AJP", "50+ BOĞMA İLE BİTİRİŞ"],
      sub: "Brezilya jiu-jitsusu. Altı ülkenin milli şampiyonu, dokuz AJP altını. 50’den fazla rakip aynı teknikle bitirildi — baseball choke. Lakap da buradan geliyor.",
    ...
    dossier: {
      ...
      cards: [
        ...
        { title: "9 AJP altını", text: "Rusya, Katar, İsviçre, İspanya, Almanya, Letonya — altı ülkede milli şampiyonluk, artı Grand Slam Moskova altını." },
    ...
    stats: [
      { label: "AJP & ACBJJ madalyası", trend: "9’u altın" },
    ...
    voices: {
      ...
      items: [
        ...
        { name: "Dmitry Safonov", role: "Spiker", org: "AJP Tour Russia", date: "Şubat 2026", text: "Nagoryansky yakayı kavradığında tribünler ayağa kalkıyor. Sıradakini herkes biliyor — ve henüz kimse durduramadı." },
      ],
    },
    pricing: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Baseball choke yeni başlayanlar için güvenli mi?", a: "Doğru öğretilirse evet. Seminerlerde önce savunmayla başlıyoruz, sonra atağa geçiyoruz. BJJ’de boğmalar kontrollüdür: tıklarsın — partnerin bırakır. Tatamideki en tehlikeli şey ego, teknik değil." },
      ],
    },
    ...
    footer: {
      about: "Brezilya jiu-jitsusu. AJP Kuzey Amerika sıralamasında 1, dünyada 2 numara. Altı ülkenin milli şampiyonu. Lozan / St. Petersburg.",
      sections: "Bölümler", training: "Antrenman", contact: "İletişim",
      collab: "İş birliği — DM’den", subscribe: "Abonelik",
      copyright: "© 2026 Vladimir Nagoryansky — The Baseball Bat. Tüm kilitlenmeler gönüllüdür.",
  ...
  lv: {
    ...
    hero: {
      ...
      typed: ["THE BASEBALL BAT", "6 VALSTU ČEMPIONS", "#1 ZIEMEĻAMERIKĀ · AJP", "50+ ŽŅAUGŠANAS FINIŠI"],
      sub: "Brazīliešu džiu-džitsu. Sešu valstu nacionālais čempions, deviņas AJP zelta medaļas. Vairāk nekā 50 pretinieku pabeigti ar vienu un to pašu paņēmienu — baseball choke. No tā arī iesauka.",
    ...
    dossier: {
      ...
      cards: [
        ...
        { title: "9 AJP zelti", text: "Krievija, Katara, Šveice, Spānija, Vācija, Latvija — nacionālie tituli sešās valstīs plus Grand Slam Moscow zelts." },
    ...
    stats: [
      { label: "AJP & ACBJJ medaļas", trend: "9 no tām — zelts" },
    ...
    voices: {
      ...
      items: [
        ...
        { name: "Dmitrijs Safonovs", role: "Komentētājs", org: "AJP Tour Russia", date: "2026. gada februāris", text: "Kad Nagorjanskis satver apkakli, tribīnes pieceļas. Visi zina, kas notiks tālāk — un neviens to vēl nav apturējis." },
      ],
    },
    pricing: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Vai baseball choke ir drošs iesācējiem?", a: "Jā, ja māca pareizi. Semināros sākam ar aizsardzību un tikai tad pārejam pie uzbrukuma. Žņaugšanas BJJ ir kontrolētas: uzsit — partneris atlaiž. Visbīstamākais uz tatami ir ego, nevis paņēmieni." },
      ],
    },
    ...
    footer: {
      about: "Brazīliešu džiu-džitsu. AJP Ziemeļamerikas ranga №1, pasaulē №2. Sešu valstu nacionālais čempions. Lozanna / Sanktpēterburga.",
      sections: "Sadaļas", training: "Treniņi", contact: "Kontakti",
      collab: "Sadarbība — rakstiet DM", subscribe: "Abonēšana",
      copyright: "© 2026 Vladimirs Nagorjanskis — The Baseball Bat. Visi sāpju paņēmieni — brīvprātīgi.",
  ...
  pt: {
    ...
    hero: {
      ...
      name1: "Vladimir", name2: "Nagoryansky",
      typed: ["THE BASEBALL BAT", "CAMPEÃO DE 6 PAÍSES", "#1 AMÉRICA DO NORTE · AJP", "50+ FINALIZAÇÕES"],
      sub: "Jiu-jitsu brasileiro. Campeão nacional de seis países, nove ouros AJP. Mais de 50 adversários finalizados com o mesmo golpe — o baseball choke. Daí o apelido.",
    ...
    dossier: {
      ...
      cards: [
        ...
        { title: "9 ouros AJP", text: "Rússia, Catar, Suíça, Espanha, Alemanha, Letônia — títulos nacionais em seis países, mais o ouro do Grand Slam de Moscou." },
    ...
    stats: [
      { label: "medalhas AJP & ACBJJ", trend: "9 delas — ouro" },
    ...
    voices: {
      ...
      items: [
        ...
        { name: "Dmitry Safonov", role: "Comentarista", org: "AJP Tour Russia", date: "Fevereiro 2026", text: "Quando Nagoryansky pega a gola, a arquibancada levanta. Todo mundo sabe o que vem a seguir — e ninguém conseguiu parar até hoje." },
      ],
    },
    pricing: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "O baseball choke é seguro para iniciantes?", a: "Sim, quando bem ensinado. Nos seminários começamos pela defesa e só depois vamos ao ataque. Estrangulamentos no BJJ são controlados: bateu — o parceiro solta. O mais perigoso no tatame é o ego, não as técnicas." },
      ],
    },
    ...
    footer: {
      about: "Jiu-jitsu brasileiro. №1 do ranking AJP da América do Norte, №2 do mundo. Campeão nacional de seis países. Lausanne / São Petersburgo.",
      sections: "Seções", training: "Treinos", contact: "Contato",
      collab: "Parcerias — chama no DM", subscribe: "Assinatura",
      copyright: "© 2026 Vladimir Nagoryansky — The Baseball Bat. Todas as finalizações são voluntárias.",
  ...
  ar: {
    ...
    hero: {
      ...
      typed: ["THE BASEBALL BAT", "بطل 6 دول", "الأول في أمريكا الشمالية · AJP", "+50 إنهاءً بالخنق"],
      sub: "جوجيتسو برازيلي. بطل وطني لست دول وتسع ذهبيات AJP. أكثر من 50 خصماً أُنهوا بالحركة نفسها — خنقة البيسبول. ومن هنا جاء اللقب.",
    ...
    dossier: {
      ...
      cards: [
        ...
        { title: "9 ذهبيات AJP", text: "روسيا وقطر وسويسرا وإسبانيا وألمانيا ولاتفيا — ألقاب وطنية في ست دول، إضافة إلى ذهبية جراند سلام موسكو." },
    ...
    stats: [
      { label: "ميداليات AJP و ACBJJ", trend: "9 منها ذهبية" },
    ...
    faq: {
      ...
      items: [
        ...
        { q: "هل خنقة البيسبول آمنة للمبتدئين؟", a: "نعم، إذا دُرّست بشكل صحيح. في الندوات نبدأ بالدفاع ثم ننتقل إلى الهجوم. الخنق في الجوجيتسو مضبوط: تربّت — فيفلت شريكك. أخطر ما على البساط هو الغرور لا التقنيات." },
      ],
    },
    ...
    footer: {
      about: "جوجيتسو برازيلي. الأول في تصنيف AJP لأمريكا الشمالية والثاني عالمياً. بطل وطني لست دول. لوزان / سانت بطرسبرغ.",
  ...
  ja: {
    ...
    hero: {
      ...
      typed: ["THE BASEBALL BAT", "6カ国チャンピオン", "北米1位 · AJP", "絞め技フィニッシュ50+"],
      sub: "ブラジリアン柔術。6カ国のナショナルチャンピオン、AJP金メダル9個。50人以上の対戦相手を同じ技で仕留めてきた——ベースボールチョーク。ニックネームの由来である。",
    ...
    dossier: {
      ...
      cards: [
        ...
        { title: "AJP金メダル9個", text: "ロシア、カタール、スイス、スペイン、ドイツ、ラトビア——6カ国のナショナルタイトルに加え、グランドスラム・モスクワの金。" },
    ...
    stats: [
      { label: "AJP & ACBJJ メダル", trend: "うち金9個" },
    ...
    faq: {
      ...
      items: [
        ...
        { q: "ベースボールチョークは初心者にも安全？", a: "正しく教えれば安全。セミナーではまず防御から始め、その後に攻撃へ移る。BJJの絞め技はコントロールされている：タップすれば相手は放す。畳の上で最も危険なのはエゴであって技ではない。" },
      ],
    },
    ...
    footer: {
      about: "ブラジリアン柔術。AJP北米ランキング1位、世界2位。6カ国のナショナルチャンピオン。ローザンヌ / サンクトペテルブルク。",
  ...
  de: {
    ...
    hero: {
      ...
      name1: "Vladimir", name2: "Nagoryansky",
      typed: ["THE BASEBALL BAT", "CHAMPION VON 6 LÄNDERN", "#1 NORDAMERIKA · AJP", "50+ CHOKE-FINISHES"],
      sub: "Brasilianisches Jiu-Jitsu. Nationaler Champion von sechs Ländern, neun AJP-Goldmedaillen. Über 50 Gegner mit ein und demselben Griff beendet — dem Baseball Choke. Daher der Spitzname.",
    ...
    dossier: {
      ...
      cards: [
        ...
        { title: "9 AJP-Goldmedaillen", text: "Russland, Katar, Schweiz, Spanien, Deutschland, Lettland — nationale Titel in sechs Ländern, plus Gold beim Grand Slam Moskau." },
    ...
    stats: [
      { label: "AJP- & ACBJJ-Medaillen", trend: "9 davon — Gold" },
    ...
    voices: {
      ...
      items: [
        ...
        { name: "Dmitry Safonov", role: "Kommentator", org: "AJP Tour Russia", date: "Februar 2026", text: "Wenn Nagoryansky den Kragen greift, stehen die Ränge auf. Jeder weiß, was als Nächstes kommt — und noch niemand konnte es stoppen." },
      ],
    },
    pricing: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Ist der Baseball Choke für Anfänger sicher?", a: "Ja, richtig unterrichtet. In Seminaren beginnen wir mit der Verteidigung und gehen erst dann zum Angriff über. Würgegriffe im BJJ sind kontrolliert: Du klopfst ab — dein Partner lässt los. Das Gefährlichste auf der Matte ist das Ego, nicht die Technik." },
      ],
    },
    ...
    footer: {
      about: "Brasilianisches Jiu-Jitsu. Nr. 1 des AJP-Rankings Nordamerika, Nr. 2 der Welt. Nationaler Champion von sechs Ländern. Lausanne / St. Petersburg.",
      sections: "Bereiche", training: "Training", contact: "Kontakt",
      collab: "Kooperationen — per DM", subscribe: "Abo",
      copyright: "© 2026 Vladimir Nagoryansky — The Baseball Bat. Alle Hebel sind freiwillig.",
      policy: "Datenschutz",
    },
  },
};
